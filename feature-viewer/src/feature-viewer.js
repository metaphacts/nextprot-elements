...
//                scaling.range([5,width-5]);
                ...
                d3.select(div).selectAll(".brush").call(brush.move, null);
            } else {
                d3.select(div).selectAll(".brush").call(brush.move, null);
                //resetAll();
            }
...
//            var currentSeqLength = svgContainer.selectAll(".AA").size();
        ...
        this.addRectSelection = function (svgId) {
            ...
            var objectSelected = {type:featSelection.node().tagName, color:featSelection.style("fill")};
...
//                            .style("padding","2px 6px")
            ...
            svgContainer.on('mousemove', function () {
                //console.log(d3.select(".background")["_groups"][0]);
        ...
        this.addFeature = function (object) {
            ...
            if (d3.selectAll(".element").node().length > 1500) animation = false;
